        ...
        <div className='flex flex-col gap-3 p-3 border-t'>
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <Avatar>
                        ...
                        <span className='font-medium text-sm md:text-md'>{admin.name}</span>
                ...
                <div className="flex gap-2 items-center">
                    ...
                    {admin.id === user.id && (
                        <Trash className='text-muted-foreground w-5 h-5 hover:text-red-500 cursor-pointer'/>
                    )}
                </div>
            </div>
            ...
            <div className="flex gap-4">
                <div className="flex gap-1 items-center">
                    ...
                    />
                    <span className='text-zinc-400 text-xs tracking-tighter'>33</span>
                </div>

                <div className="flex gap-1 items-center">
                    <MessageCircle className='w-5 h-5 cursor-pointer'/>
                    <span className='text-zinc-400 text-xs tracking-tighter'>44</span>
                </div>
            </div>
