                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={global.text}>
                            We're really happy to see you on our platform. We
                            hope you have a great experience and enjoy all the
                            features we offer.
                        </Text>
                        <Hr style={global.hr} />
                        ...
                        <Text style={{ ...global.text, marginTop: 24 }}>
                            Thanks for subscribing! We will see you in the
                            platform. 🙂❤
                        </Text>
                        <Link
                            href={BASE_URL}
                    ...
                    <Section style={global.defaultPadding}>
                        <Text style={footer.text}>
                            © {new Date().getFullYear()} OnlyCats, Inc. All
                            Rights Reserved.
                        </Text>
                    </Section>
                </Container>
